...
{var d=b.getElementsByTagName("TR"),e={},a;for(a in c)c.hasOwnProperty(a)&&(e[a]=c[a]instanceof filterTable.Filter?c[a]:new filterTable.Filter(c[a]),e[a]._setAction("onchange",function(){var a,c,b;for(c=0;c<d.length;c+=1)for(b in a=d.item(c),e)if(e.hasOwnProperty(b))if(!1===e[b].validate(a.children[b].innerText)){a.style.display="none";break}else a.style.display=""}))};
{var d=b.getElementsByTagName("TR"),e={},a;for(a in c)c.hasOwnProperty(a)&&(e[a]=c[a]instanceof filterTable.Filter?c[a]:new filterTable.Filter(c[a]),e[a]._setAction("onchange",function(){var a,c,b;for(c=0;c<d.length;c+=1)for(b in a=d.item(c),e)if(e.hasOwnProperty(b))if(!1===e[b].validate(a.children[b].innerText)){a.style.display="none";break}else a.style.display=""}))};
